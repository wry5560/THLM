	...
	<a-spin :spinning="loading">
		...
		>
			<a-flex :align="`center`" wrap="wrap">
				<span v-if="productType == 'Seed'" style="width: 75px"
					>种子：</span
				>
				<span v-if="productType == 'Fertilizer'" style="width: 75px"
					>肥料：</span
				>
				<span v-if="productType == 'Feed'" style="width: 75px"
					>饲料：</span
				>
				...
				>
					<a-card
						...
						v-if="item.name.includes(productType)"
					>
						<template #cover>
							<span
								style="
...
const types = ref(["Seed", "Fertilizer", "Feed"]);
